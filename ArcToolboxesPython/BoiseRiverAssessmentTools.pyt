...
class Toolbox(object):
    def __init__(self):
        ...
        self.tools = [CalcHSI,CalcHSIver2]
        ...
        for depRas in DepthRasters:
            for velRas in VelocityRasters:
                if (depRas[3:]) == (velRas[3:]):
                    ...
                    # Brown Trout HSI calcs
                    if (BrownTroutCondition) and (SpawnCondition):
                    ...
                    elif (BrownTroutCondition) and (FryCondition):
                        ...
                        Delete_management(DepthRaster)
                        Delete_management(VelocityRaster)
                    elif (BrownTroutCondition) and (JuvenileCondition):
                        ...
                        Delete_management(DepthRaster)
                        Delete_management(VelocityRaster)
                    elif (BrownTroutCondition) and (AdultCondition):
                    ...
                    # Mountain Whitefish Calcs
                    elif (MountainWhitefishCondition) and (SpawnCondition):
                        ...
                        Delete_management(DepthRaster)
                        Delete_management(VelocityRaster)
                    elif (MountainWhitefishCondition) and (FryCondition):
                        AddMessage("No fry data for mountain whitefish")
                    elif (MountainWhitefishCondition) and (JuvenileCondition):
                        ...
                        Delete_management(DepthRaster)
                        Delete_management(VelocityRaster)
                    elif (MountainWhitefishCondition) and (AdultCondition):
                    ...
                    # Rainbow Trout HSI calcs
                    elif (RainbowTroutCondition) and (SpawnCondition):
                        ...
                        Delete_management(DepthRaster)
                        Delete_management(VelocityRaster)
                    elif (RainbowTroutCondition) and (FryCondition):
                        ...
                        Delete_management(DepthRaster)
                        Delete_management(VelocityRaster)
                    elif (RainbowTroutCondition) and (JuvenileCondition):
                        ...
                        Delete_management(DepthRaster)
                        Delete_management(VelocityRaster)
                    elif (RainbowTroutCondition) and (AdultCondition):
                    ...
                    # Sculpin HSI calcs
                    elif (SculpinCondition) and (JuvenileCondition):
                        ...
                        Delete_management(DepthRaster)
                        Delete_management(VelocityRaster)
                    elif (SculpinCondition) and (AdultCondition):
                        ...
                        Delete_management(DepthRaster)
                        Delete_management(VelocityRaster)
                    elif (SculpinCondition) and (SpawnCondition):
                        AddMessage("NOTE: There is no data available for spawn sculpin")
        return

class CalcHSIver2(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
